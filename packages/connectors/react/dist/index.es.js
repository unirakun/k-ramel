...
var inject = (function (injectFunction) {
  return function (WrappedComponent) {
    ...
    return _temp = _class = function (_Component) {
      ...
      return _class;
    }(Component), _class.displayName = 'inject(' + getWrappedDisplayName(WrappedComponent), _class.contextTypes = {
...
var provider = (function (store) {
  return function (WrappedComponent) {
    ...
    return _temp = _class = function (_Component) {
      ...
      return _class;
    }(Component), _class.displayName = 'provider(' + getWrappedDisplayName(WrappedComponent) + ')', _class.childContextTypes = {
      store: function store() {
        return null;
      } // this is to avoid importing prop-types
    }, _temp;
