(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('redux-form')) :
	typeof define === 'function' && define.amd ? define(['redux-form'], factory) :
	(global['@k-ramel/driver-redux-form'] = factory(global.reduxform));
}(this, (function (reduxform) { 'use strict';
...
var reduxForm = (function (getFormState) {
  return function (store) {
    return function (name) {
      return _extends({}, actions(store)(name), selectors(getFormState)(store)(name), customActions(store)(name));
    };
  };
});
