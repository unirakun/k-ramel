...
var types = {
  array: function array(params) {
    return _extends({}, params, { type: 'simple.array' });
  },
  bool: function bool(params) {
    return _extends({}, params, { type: 'simple.bool' });
  },
  string: function string(params) {
    return _extends({}, params, { type: 'simple.string' });
  },
  object: function object(params) {
    return _extends({}, params, { type: 'simple.object' });
  },
  keyValue: function keyValue(params) {
...
export { createStore$1 as createStore, types, keyValue, simpleObject, _when as when, reaction, reactions };
